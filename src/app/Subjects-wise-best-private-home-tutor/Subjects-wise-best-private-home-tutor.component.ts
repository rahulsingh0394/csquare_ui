...
@Component({
  selector: 'app-Subjects-wise-best-private-home-tutor',
  templateUrl: './Subjects-wise-best-private-home-tutor.html',
  styleUrls: ['./Subjects-wise-best-private-home-tutor.scss'],
  providers: [Location, { provide: LocationStrategy, useClass: PathLocationStrategy }],
})
export class SubjectsWiseComponent implements OnInit {
